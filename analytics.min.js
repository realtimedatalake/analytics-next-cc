!(function () {
  var t,
    ...
    i = {
      ...
      747: function (t, e, n) {
        ...
        function l(t, e) {
          ;(e = e || {}),
            ...
            (t.timestamp =
              'timestamp' in t ? s.default(t.timestamp) : new Date()),
        ...
        ;(f.proxy = function (t) {
          ...
          (l.multi = function (t) {
            return function () {
              ...
              var n = this.proxy(t)
              return n && (n = [this.opts.clone ? o.klona(n) : n]), n || []
            }
          }),
          (l.one = function (t) {
            return function () {
        ...
        e.klona = function t(e) {
          ...
          if ('[object Object]' === i) {
            if (e.constructor !== Object && 'function' == typeof e.constructor)
              for (n in ((r = new e.constructor()), e))
                e.hasOwnProperty(n) && r[n] !== e[n] && (r[n] = t(e[n]))
            else
              for (n in ((r = {}), e))
                '__proto__' === n
          ...
          if ('[object Array]' === i) {
            for (n = e.length, r = Array(n); n--; ) r[n] = t(e[n])
            return r
          }
          return '[object Date]' === i
            ? new Date(+e)
            : '[object RegExp]' === i
            ? (((r = new RegExp(e.source, e.flags)).lastIndex = e.lastIndex), r)
            : e
        }
      },
      8013: function (t, e, n) {
        ...
        t.exports = (function (t) {
          ...
          return (
            ...
            (h.ArrayBuffer.prototype.setState = function (t) {
              return (
                (t.buff = l(t.buff, !0)), h.prototype.setState.call(this, t)
              )
            }),
        ...
        var r,
          ...
          s = (function () {
            function t() {
              var t = this
              ;(this._logs = []),
                (this.log = function (e, n, r) {
                  var i = new Date()
                  t._logs.push({ level: e, message: n, time: i, extras: r })
                })
            }
            return (
            ...
            return (
              (t.prototype.increment = function (t, e, n) {
                ...
                void 0 === e && (e = 1),
                  ...
                  null === (r = this.remoteMetrics) ||
                    void 0 === r ||
                    r.increment(t, null != n ? n : [])
              }),
              ...
              (t.prototype.flush = function () {
                var t = this.metrics.map(function (t) {
                  return (0, u.pi)((0, u.pi)({}, t), { tags: t.tags.join(',') })
                })
                console.table ? console.table(t) : console.log(t),
                  (this.metrics = [])
              }),
            ...
            return (
              ...
              (t.prototype.updateEvent = function (t, e) {
                ...
                if ('integrations' === t.split('.')[0]) {
                  ...
                  if (
                    !1 ===
                    (null === (n = this._event.integrations) || void 0 === n
                      ? void 0
                      : n[r])
                  )
                    return this._event
      ...
      57: function (t, e, n) {
          ...
          return void 0 === o
            ...
            : (function (t) {
                ...
                .then(function (t) {
                  ...
                  return (
                    t.stats.gauge('plugin_time', r, ['plugin:' + e.name]), t
                  )
                })
                .catch(function (n) {
        ...
        function u(t, e) {
          return o(t, e).then(function (e) {
            return void 0 === e || e instanceof Error
              ...
              if (
                ((this.host =
                  null !== (e = null == t ? void 0 : t.host) && void 0 !== e
                    ...
                    : 'api.segment.io/v1'),
                (this.sampleRate =
                  null !== (n = null == t ? void 0 : t.sampleRate) &&
                  void 0 !== n
                    ? n
                    : 1),
                (this.flushTimer =
                  null !== (r = null == t ? void 0 : t.flushTimer) &&
                  void 0 !== r
                    ? r
                    : 3e4),
                (this.maxQueueSize =
                ...
                var u = !1,
                  s = function () {
                    u ||
                      ((u = !0),
                      o.flush().catch(function (t) {
                        console.error(t)
                      }),
                      (u = !1),
                      setTimeout(s, o.flushTimer))
                  }
                s()
              }
            }
        ...
        function o(t) {
          for (
            ...
            var r = '__tld__',
              o = e[n],
              u = { domain: '.' + o }
            if ((i().set(r, '1', u), i().get(r))) return i().remove(r, u), o
          }
        }
      },
      1594: function (t, e, n) {
      ...
      6673: function (t, e, n) {
        ...
        function i(t, e) {
          ...
          return new Promise(function (r, i) {
            var o,
              u = n.g.window.document.createElement('script')
            ;(u.type = 'text/javascript'),
              (u.src = t),
              (u.async = !0),
              u.setAttribute('status', 'loading')
            for (
            ...
            ;(u.onload = function () {
              ;(u.onerror = u.onload = null),
                u.setAttribute('status', 'loaded'),
                r(u)
            }),
              (u.onerror = function () {
                ;(u.onerror = u.onload = null),
                  u.setAttribute('status', 'error'),
                  i(new Error('Failed to load ' + t))
              })
            var p = n.g.window.document.getElementsByTagName('script')[0]
            null === (o = p.parentElement) ||
              void 0 === o ||
              o.insertBefore(u, p)
          })
        }
        ...
        function i(t, e) {
          ...
          return Object.entries(t.integrations).reduce(function (t, e) {
            var n,
              ...
              u = e[1]
            return (0,
            r.pi)((0, r.pi)({}, t), (((n = {})[o] = (0, r.pi)((0, r.pi)({}, u), i[o])), n))
          }, {})
        }
      },
      3319: function (t, e, n) {
      ...
      46: function (t, e, n) {
        ...
        var r = n(1333),
          i = /(https:\/\/.*)\/analytics\.js\/v1\/(?:.*?)\/(?:platform|analytics.*)?/
        function o() {
          var t = void 0
          return (
        ...
        function u() {
          for (
            var t,
              e,
              n =
                null !== (t = (0, r.M)()) && void 0 !== t
                  ? t
                  : window.analytics._writeKey,
              o = void 0,
              u = 0,
            ...
            var a =
                null !== (e = s[u].getAttribute('src')) && void 0 !== e
                  ? e
                  : '',
              c = i.exec(a)
            if (c && c[1]) {
          ...
          return o
            ? o.replace('analytics.min.js', 'analytics.classic.js')
      ...
      306: function (t, e, n) {
        ...
        function f(t, e, n) {
          void 0 === n && (n = 0)
          var r = 'persisted-queue:v1:' + t + ':lock',
            i = s.getItem(r),
          ...
          if (u)
            return (
              s.setItem(r, JSON.stringify(new Date().getTime() + 50)),
              e(),
              void s.removeItem(r)
            )
          if (u || !(n < 3)) throw new Error('Unable to retrieve lock')
          setTimeout(function () {
            f(t, e, n + 1)
          }, 50)
        }
          ...
          function e(e, n) {
            ...
            return (
              ...
              window.addEventListener('beforeunload', function () {
                if (i.todo > 0) {
                  var t = (0, r.pr)(i.queue, i.future)
                  try {
                    f(n, function () {
                      !(function (t, e) {
                        var n = a(t),
                          i = (0, r.pr)(e, n).reduce(function (t, e) {
                            var n
                            return (0,
                            r.pi)((0, r.pi)({}, t), (((n = {})[e.id] = e), n))
                          }, {})
      ...
      9841: function (t, e, n) {
        ...
        var r = n(655),
          ...
          a = void 0
        try {
          a = (0, u.P)(new URL(window.location.href))
        } catch (t) {
          a = void 0
        }
        var c = { expires: 31536e6, secure: !1, path: '/' }
        a && (c.domain = a)
        var l = 'npm'
        function f(t) {
          l = t
        ...
        function d(t, e, n, u) {
          ...
          e.context =
            null !==
              (l = null !== (a = e.context) && void 0 !== a ? a : e.options) &&
            void 0 !== l
              ? l
              : {}
          var v = e.context,
            y = e.anonymousId
          delete e.options,
            (e.writeKey = null == n ? void 0 : n.apiKey),
            (v.userAgent = window.navigator.userAgent)
          var m = navigator.userLanguage || navigator.language
          if (
            (void 0 === v.locale && void 0 !== m && (v.locale = m), !v.library)
          ) {
            var g = p()
            v.library =
              'web' === g
                ? { name: 'analytics.js', version: 'next-' + s.i }
                : { name: 'analytics.js', version: 'npm:next-' + s.i }
          }
          h &&
            !v.campaign &&
            ...
            (function (t, e) {
              var n = (0, i.get)('s:context.referrer'),
                o = (function (t) {
              ...
              ;(n = n ? JSON.parse(n) : void 0),
                (o = null != o ? o : n) &&
                  (e && (e.referrer = (0, r.pi)((0, r.pi)({}, e.referrer), o)),
                  (0, i.set)('s:context.referrer', JSON.stringify(o), c))
            })(h, v),
            (e.userId = e.userId || d.id()),
            (e.anonymousId = d.anonymousId(y)),
            (e.sentAt = new Date()),
            (e.timestamp = new Date())
          var b = t.queue.failedInitializations || []
          b.length > 0 && (e._metadata = { failedInitializations: b })
          var w = [],
            _ = []
          for (var x in u) {
            var j = u[x]
            'Segment.io' === x && w.push(x),
              'bundled' === j.bundlingStatus && w.push(x),
              'unbundled' === j.bundlingStatus && _.push(x)
          }
          for (
            var I = 0, P = (null == n ? void 0 : n.unbundledIntegrations) || [];
            I < P.length;
            I++
          ) {
            var S = P[I]
          ...
          var O =
              null !== (f = null == n ? void 0 : n.maybeBundledConfigIds) &&
              void 0 !== f
                ? f
                : {},
            k = []
          w.sort().forEach(function (t) {
            var e
            ;(null !== (e = O[t]) && void 0 !== e ? e : []).forEach(function (
              t
            ) {
              k.push(t)
            })
          }),
            !1 !== (null == n ? void 0 : n.addBundledMetadata) &&
              (e._metadata = (0, r.pi)((0, r.pi)({}, e._metadata), {
                bundled: w.sort(),
                unbundled: _.sort(),
                bundledIds: k,
              }))
  ...
  ;(u.m = i),
    ...
    (u.u = function (t) {
      return (
        ...
        '.bundle.' +
        {
          96: '370fa72493b0676e0187',
          119: '769e1a1fd232b17a2cdd',
          130: '55742ac9337d9e12bdd6',
          150: '9696ca5ac5192aaf6635',
          214: 'ff835f0201c24f96eebb',
          464: '36b90a11867ae217be52',
          493: 'b2bf2b63b07c356b1232',
          714: '525dc928eb47a1da146e',
          834: 'e062bb312a089f94d2f9',
        }[t] +
        '.js'
      )
    }),
    ...
    (function () {
      ...
      var e = function (e, n) {
          ...
          for (e && e(n); c < o.length; c++)
            (i = o[c]), u.o(t, i) && t[i] && t[i][0](), (t[o[c]] = 0)
        },
  ...
  !(function () {
    ...
    function f(t) {
      var e,
        n = t && t.event && t.event.type,
        r = t.event
      if (void 0 === r) throw new l('event', 'Event is missing')
      if (!i(n)) throw new l('event', 'Event is not a string')
      if ('track' === n && !i(r.event))
        throw new l('event', 'Event is not a string')
      var o = null !== (e = r.properties) && void 0 !== e ? e : r.traits
      if ('alias' !== n && !c(o))
        throw new l('properties', 'properties is not an object')
      if (
        !(function (t) {
          var e, n, r
          return i(
        ...
        throw new l('userId', 'Missing userId or anonymousId')
      return t
    }
    var p = {
    ...
    function d(t, e, n, r) {
      var o,
        u = [t, e, n, r],
        s = c(t) ? t.event : t
      if (!s || !i(s)) throw new Error('Event missing')
      var l = c(t)
    ...
    function h(t, e, n, r, o) {
      var u,
        ...
        p = [t, e, n, r, o],
        d = p.filter(i)
      void 0 !== d[0] && void 0 !== d[1] && ((l = d[0]), (f = d[1])),
        1 === d.length && ((l = null), (f = d[0]))
      var h = p.find(a),
        v = p.filter(function (t) {
          return null === f ? c(t) : c(t) || null === t
        }),
        y = null !== (u = v[0]) && void 0 !== u ? u : {},
        m = null !== (s = v[1]) && void 0 !== s ? s : {}
      return [l, f, y, m, h]
    }
    var v = function (t) {
      return function () {
        for (var e, n, r, u, s, l = [], f = 0; f < arguments.length; f++)
          l[f] = arguments[f]
        var p = null
        p =
          null !==
            (r =
              null !== (e = l.find(i)) && void 0 !== e
                ? e
                : null === (n = l.find(o)) || void 0 === n
                ? void 0
                : n.toString()) && void 0 !== r
            ? r
            : t.id()
        var d = l.filter(function (t) {
            return null === p ? c(t) : c(t) || null === t
          }),
    ...
    function y(t, e, n, r) {
      o(t) && (t = t.toString()), o(e) && (e = e.toString())
      var u = [t, e, n, r],
        s = u.filter(i),
        l = s[0],
        f = void 0 === l ? t : l,
        ...
        d = void 0 === p ? null : p,
        h = u.filter(c)[0]
      return [f, d, void 0 === h ? {} : h, u.find(a)]
    }
    var m = u(5546),
      g = u(8231),
      b = u(7372),
      w = (function () {
        ...
        return (
          (e.prototype.on = function (e, n) {
            var r
            return (
              (this.callbacks[e] = (0, t.pr)(
                null !== (r = this.callbacks[e]) && void 0 !== r ? r : [],
                [n]
              )),
              this
            )
          ...
          (e.prototype.off = function (t, e) {
            var n,
              r = (null !== (n = this.callbacks[t]) && void 0 !== n
                ? n
                : []
              ).filter(function (t) {
                return t !== e
        ...
        return (
          ...
          (e.prototype.page = function (e, n, r, i, o) {
            ...
            return (
              null !== e &&
                ((s.category = e),
                (s.properties =
                  null !== (u = s.properties) && void 0 !== u ? u : {}),
          ...
          (e.prototype.context = function (t) {
            ...
            return (
              u.forEach(function (t) {
                'context' !== t &&
                  (i.includes(t) ? (0, x.N)(a, t, o[t]) : (0, x.N)(s, t, o[t]))
              }),
              [s, a]
            )
          }),
          (e.prototype.normalize = function (e) {
            var n,
              ...
              l = (0, t.pi)(
                (0, t.pi)((0, t.pi)({}, c), { context: s, integrations: o }),
                a
              ),
              f = 'ajs-next-' + I().hash(JSON.stringify(l) + (0, _.v4)())
            return (0, t.pi)((0, t.pi)({}, l), { messageId: f })
          }),
          e
        )
      })()
      ...
      k = (function (e) {
        function n(t) {
          ...
          return (
            ...
            (n.flushing = !1),
            (n.queue = null != t ? t : new S.$(4, 'event-queue')),
            n.scheduleFlush(),
            n
          )
        }
              ...
              return (0, t.Jh)(this, function (t) {
                return [
                  ...
                  new Promise(function (t, r) {
                    var i = function (o, u) {
                      o.isSame(e) && (n.off('flush', i), u ? t(o) : r(o))
                    }
                    n.on('flush', i)
                  }),
                ]
                ...
                return (
                  ...
                  [
                    ...
                    this.deliver(e).catch(function (t) {
                      if (t instanceof b.Y && !1 === t.retry) return e
                      if (!n.enqueuRetry(t, e)) throw t
                      return n.subscribeToDelivery(e)
                    }),
                  ]
                )
              })
            ...
            return (0, t.mG)(this, void 0, Promise, function () {
              ...
              return (0, t.Jh)(this, function (t) {
                switch (t.label) {
                  ...
                  case 1:
                    return t.trys.push([1, 3, , 4]), [4, this.flushOne(e)]
                  case 2:
                    return (
                      (e = t.sent()),
                      (r = Date.now() - n),
          ...
          (n.prototype.flush = function () {
            return (0, t.mG)(this, void 0, Promise, function () {
              ...
              return (0, t.Jh)(this, function (t) {
                switch (t.label) {
                  case 0:
                    if (0 === this.queue.length || !(0, g.G)()) return [2, []]
                  ...
                  case 3:
                    return (
                      (n = t.sent()),
                      this.enqueuRetry(n, e) || this.emit('flush', e, !1),
                      [2, []]
                    )
                  case 4:
                    return [2, [e]]
          ...
          (n.prototype.availableExtensions = function (e) {
            var n,
              ...
              i = this.plugins.filter(function (t) {
                ...
                return (
                  'destination' !== t.type ||
                  !1 !== (null !== (n = e[t.name]) && void 0 !== n ? n : e.All)
                )
              }),
              o =
                ((n = 'type'),
                ...
                switch (t.label) {
                  ...
                  case 5:
                    return l < f.length
                      ...
                      : [3, 8]
                  case 6:
                    ;(d = t.sent()) instanceof b._ && (e = d), (t.label = 7)
                  case 7:
                    return l++, [3, 5]
                  case 8:
                    return (
    ...
    var T = {
      ...
      C = void 0
    try {
      C = (0, E.P)(new URL(window.location.href))
    } catch (t) {
      C = void 0
    }
    var M = (function (e) {
          ...
          (n.prototype.set = function (t, e) {
            return (
              'string' == typeof e
                ? F().set(t, e, this.opts())
                : null === e
                ? F().remove(t, this.opts())
                : F().set(t, JSON.stringify(e), this.opts()),
              e
            )
          }),
          (n.prototype.remove = function (t) {
            return F().remove(t, this.opts())
          }),
          (n.defaults = { maxage: 365, domain: C, path: '/', sameSite: 'Lax' }),
          n
        )
      })(q),
      G = (function (e) {
        ...
        return (
          ...
          (n.prototype.set = function (t, e) {
            try {
              ...
              console.warn(
                'Unable to set ' + t + ' in localStorage, storage may be full.'
              )
            }
            return e
          }),
        ...
        function e(t, e) {
          ...
          void 0 === t && (t = T),
            ...
            (this.id = function (t) {
              var e,
                n,
                r = u.chainGet(u.idKey)
              void 0 !== t &&
                (u.trySet(u.idKey, t),
                t !== r && null !== r && null !== t && u.anonymousId(null))
              return null !==
                (n =
                  null !== (e = u.chainGet(u.idKey)) && void 0 !== e
                    ? e
                    : u.cookies.get(T.cookie.oldKey)) && void 0 !== n
                ? n
                : null
            }),
            (this.anonymousId = function (t) {
              ...
              if (void 0 === t) {
                var r =
                  null !== (e = u.chainGet(u.anonKey)) && void 0 !== e
                    ? e
              ...
              return null === t
                ? (u.trySet(u.anonKey, null), u.chainGet(u.anonKey))
                : (u.trySet(u.anonKey, null != t ? t : (0, _.v4)()),
                  u.chainGet(u.anonKey))
            }),
            (this.traits = function (t) {
              ...
              return (
                null === t && (t = {}),
                t &&
                  (u.mem.set(u.traitsKey, null != t ? t : {}),
                  u.localStorage.set(u.traitsKey, null != t ? t : {})),
                null !==
                  (n =
                    null !== (e = u.localStorage.get(u.traitsKey)) &&
                    void 0 !== e
                      ? e
                      : u.mem.get(u.traitsKey)) && void 0 !== n
                  ? n
                  : {}
              )
            }),
          ...
          var s = !1 !== t.persist
          ;(this.localStorage =
            !t.localStorageFallbackDisabled && s && D.available()
              ? new D()
              : new G()),
            (this.cookies = s && M.available() ? new M(e) : new G())
          var a = this.cookies.get(T.cookie.oldKey)
          a && (a.id && this.id(a.id), a.traits && this.traits(a.traits)),
            J(this)
        }
        return (
          (e.prototype.chainGet = function (t) {
            var e,
              n,
              r,
              i =
                null !==
                  (r =
                    null !==
                      (n =
                        null !== (e = this.localStorage.get(t)) && void 0 !== e
                          ? e
                          : this.cookies.get(t)) && void 0 !== n
                      ? n
                      : this.mem.get(t)) && void 0 !== r
                  ? r
                  : null
      ...
      B = (function (e) {
        function n(t, n) {
          ...
          return (r.anonymousId = function (t) {}), J(r), r
        }
        return (0, t.ZT)(n, e), n
      })(N),
      z = u(1594),
      ...
      R = (function (e) {
        function n(t, n, r, i, o) {
          ...
          var c = null == n ? void 0 : n.cookie
          return (
            (a.settings = t),
            (a.settings.timeout =
              null !== (u = a.settings.timeout) && void 0 !== u ? u : 300),
            (a.queue =
              null != r
                ? r
                : new k(
                    new S.$(
                      (null == n ? void 0 : n.retryQueue) ? 4 : 1,
                      'event-queue'
                    )
                  )),
            (a._user =
              null != i ? i : new N(null == n ? void 0 : n.user, c).load()),
            (a._group =
              null != o ? o : new B(null == n ? void 0 : n.group, c).load()),
            (a.eventFactory = new P(a._user)),
            (a.integrations =
              null !== (s = null == n ? void 0 : n.integrations) && void 0 !== s
                ? s
                : {}),
            (a.options = null != n ? n : {}),
            J(a),
        ...
        return (
            ...
            return (0, t.mG)(this, void 0, Promise, function () {
              ...
              return (0, t.Jh)(this, function (t) {
                return (
                  ...
                  [
                    2,
                    this.dispatch(s, u).then(function (t) {
                      return (
                        a.emit('track', r, t.event.properties, t.event.options),
                        t
                      )
                    }),
                  ]
            ...
            return (0, t.mG)(this, void 0, Promise, function () {
              ...
              return (0, t.Jh)(this, function (t) {
                return (
                  ...
                  [
                    2,
                    this.dispatch(a, s).then(function (t) {
                      return (
                        c.emit(
                          'page',
                          r,
          ...
          (n.prototype.group = function () {
            ...
            var a = this._group.id(),
              ...
              l = this.eventFactory.group(a, c, u, this.integrations)
          ...
          (n.prototype.trackClick = function () {
            ...
            return (0, t.mG)(this, void 0, Promise, function () {
              ...
              return (0, t.Jh)(this, function (i) {
                switch (i.label) {
                  case 0:
                    return [4, u.e(119).then(u.bind(u, 2839))]
                  case 1:
                    return (
                      (n = i.sent()),
                      [2, (r = n.link).call.apply(r, (0, t.pr)([this], e))]
                    )
                }
              })
            })
              ...
              return (0, t.Jh)(this, function (i) {
                switch (i.label) {
                  ...
                  case 1:
                    return (
                      (n = i.sent()),
                      [2, (r = n.form).call.apply(r, (0, t.pr)([this], e))]
                    )
                }
              })
            })
                        ...
                        return (0, t.mG)(i, void 0, void 0, function () {
                          ...
                          return (0, t.Jh)(this, function (t) {
                            return (r = this.queue.plugins.find(function (t) {
                              ...
                              ? [2, this.queue.deregister(n, r, this)]
              ...
              return (0, t.Jh)(this, function (t) {
                switch (t.label) {
                  case 0:
                    return (
                      (r = new b._(e)),
                      (0, g.s)() && !this.options.retryQueue
                        ? [2, r]
                        : this.queue.isEmpty()
                        ? [4, this.queue.dispatchSingle(r)]
                        : [3, 2]
                    )
                  case 1:
                    return (i = t.sent()), [3, 4]
                  ...
                  case 4:
                    return n
                      ? [4, (0, m.U)(i, n, this.settings.timeout)]
                      : [3, 6]
                  case 5:
                    ;(i = t.sent()), (t.label = 6)
                  case 6:
          ...
          (n.prototype.addSourceMiddleware = function (e) {
            return (0, t.mG)(this, void 0, Promise, function () {
              ...
              return (0, t.Jh)(this, function (t) {
                switch (t.label) {
                  case 0:
                    return [4, u.e(714).then(u.bind(u, 2734))]
                  case 1:
                    return (
          ...
          (n.prototype.queryString = function (e) {
            return (0, t.mG)(this, void 0, Promise, function () {
              return (0, t.Jh)(this, function (t) {
                switch (t.label) {
                  case 0:
                    return [4, u.e(96).then(u.bind(u, 8309))]
                  case 1:
          ...
          (n.prototype.noConflict = function () {
            return (
              console.warn(K), (window.analytics = null != U ? U : this), this
            )
          }),
          (n.prototype.normalize = function (t) {
            return console.warn(K), this.eventFactory.normalize(t)
          }),
          Object.defineProperty(n.prototype, 'failedInitializations', {
            get: function () {
              return console.warn(K), this.queue.failedInitializations
            },
            enumerable: !1,
            configurable: !0,
          }),
          ...
          (n.prototype.initialize = function (e, n) {
            return (0, t.mG)(this, void 0, Promise, function () {
              return (0, t.Jh)(this, function (t) {
                switch (t.label) {
                  case 0:
                    return console.warn(K), e ? [4, vt.load(e, n)] : [3, 2]
                  case 1:
                    t.sent(), (t.label = 2)
                  case 2:
                    return (this.options = n || {}), [2, this]
                }
              })
            })
          }),
          (n.prototype.pageview = function (e) {
            return (0, t.mG)(this, void 0, Promise, function () {
              return (0, t.Jh)(this, function (t) {
                switch (t.label) {
                  case 0:
                    return console.warn(K), [4, this.page({ path: e })]
                  case 1:
                    return t.sent(), [2, this]
                }
              })
          ...
          (n.prototype.addIntegrationMiddleware = function () {
            console.warn(K)
          }),
          ...
          (n.prototype.hasListeners = function () {
            console.warn(K)
          }),
          (n.prototype.addIntegration = function () {
            console.warn(K)
          }),
    ...
    function V() {
      ...
      return (
        (e.href = t), e.pathname.startsWith('/') ? e.pathname : '/' + e.pathname
      )
    }
    function Y(t) {
      void 0 === t && (t = '')
    ...
    function Q(t) {
      ...
      return (
        ...
        n.context.page && (r = Object.assign({}, r, n.context.page)),
        (n.context = Object.assign({}, n.context, { page: r })),
        (t.event = n),
        t
      )
    }
    var H = {
        ...
        page: function (t) {
          return (
            (t.event.properties = Object.assign({}, $(), t.event.properties)),
      ...
      return (0, t.mG)(this, void 0, Promise, function () {
        ...
        return (0, t.Jh)(this, function (l) {
          switch (l.label) {
            case 0:
              return (
                ...
                (s =
                  null !==
                    (i =
                      null === (r = window.analytics) || void 0 === r
                        ? void 0
                        : r._cdn) && void 0 !== i
                    ? i
                    : (0, e.V)()),
                (a = (null !== (o = n.remotePlugins) && void 0 !== o
                  ? o
                  : []
                ).map(function (e) {
                  return (0, t.mG)(c, void 0, void 0, function () {
                    var n, r, i, o, a
                    return (0, t.Jh)(this, function (t) {
                      switch (t.label) {
                        case 0:
                          return (
                            ...
                            [
                              4,
                              (0, tt.v)(
                                e.url.replace('https://cdn.segment.com', s)
                              ),
                            ]
                          )
                        case 1:
                          return (
                            ...
                            'function' != typeof window[n]
                              ? [3, 3]
                              : ((r = window[n]), [4, (0, X.O)(r(e.settings))])
                          )
                        case 2:
                          ;(i = t.sent()),
                            (function (t) {
                        ...
                        case 4:
                          return (
                            (a = t.sent()),
                            console.warn('Failed to load Remote Plugin', a),
                            [3, 5]
                          )
                        case 5:
                          return [2]
            ...
            case 1:
              return l.sent(), [2, u.filter(Boolean)]
          }
        })
      })
    }
    var nt = u(2722),
      rt = r.Z
    'undefined' != typeof window && (rt = window.fetch || r.Z)
    function it(t) {
    ...
    function ot(e, n) {
      var r,
        ...
        u = [],
        s = !1,
        a = null !== (r = null == n ? void 0 : n.size) && void 0 !== r ? r : 10,
        c =
      ...
      function l() {
        ...
        if (!s) {
          ...
          ;(u = []), (s = !1)
          var i = null === (t = r[0]) || void 0 === t ? void 0 : t.writeKey
          return rt(n, {
            headers: { 'Content-Type': 'text/plain' },
            method: 'post',
            body: JSON.stringify({ batch: r, writeKey: i }),
          })
        }
      }
      var f = p()
        ...
        window.addEventListener('beforeunload', function () {
          if (0 !== u.length) {
            var n = (function (t) {
              ...
              return (
                t.forEach(function (t) {
                  it(e[n]) >= 64 && n++, e[n] ? e[n].push(t) : (e[n] = [t])
                }),
                e
              )
            })(
                    ...
                    : ((r = 'https://' + e + '/b'),
                      ...
                      [
                        ...
                        rt(r, {
                          ...
                          headers: { 'Content-Type': 'text/plain' },
                          method: 'post',
                          body: JSON.stringify({ batch: n, writeKey: i }),
                        }),
                      ])
                })
              })
    ...
    var ut = r.Z
    'undefined' != typeof window && (ut = window.fetch || r.Z)
    var st = u(3319)
    function at(e, n) {
      return (0, t.mG)(this, void 0, Promise, function () {
        var r,
    ...
    function lt(e, r, i) {
      var o,
        u,
        s,
        a = new S.$(e.queue.queue.maxAttempts, 'dest-Segment.io'),
        c =
          null !== (o = null == r ? void 0 : r.apiHost) && void 0 !== o
            ? o
            : 'api.segment.io/v1',
        l = 'https://' + c,
        f =
          'batching' ===
          (null === (u = null == r ? void 0 : r.deliveryStrategy) ||
          void 0 === u
            ? void 0
            : u.strategy)
            ? ot(
                c,
                null === (s = null == r ? void 0 : r.deliveryStrategy) ||
                  void 0 === s
                  ? void 0
                  : s.config
              )
      ...
      function p(o) {
        return (0, t.mG)(this, void 0, Promise, function () {
          ...
          return (0, t.Jh)(this, function (t) {
            return (0, g.s)()
              ? (a.push(o), ct(false, a, d, ct), [2, o])
              : ((u = o.event.type.charAt(0)),
                (s = (0, nt.D)(o.event).json()),
                'track' === o.event.type && delete s.traits,
                'alias' === o.event.type &&
                  (s = (function (t, e) {
                    var n,
                      r,
                ...
                null != e.options.ccUrl &&
                  e.options.ccUrl.length > 0 &&
                  f
                    .dispatch('' + e.options.ccUrl, (0, n.Fv)(e, s, r, i))
                    .then(function () {
                      return o
                    })
                    .catch(function (t) {
                      console.warn(
                        t.message +
                          '\nError sending to ccURL: ' +
                          e.options.ccUrl
                      )
                    }),
                null != e.options.dontSendToSegment &&
                e.options.dontSendToSegment
                  ? [2, o]
                  : [
                      2,
                      f
                        .dispatch(l + '/' + u, (0, n.Fv)(e, s, r, i))
                        .then(function () {
                          return o
                        })
                        .catch(function (t) {
      ...
      var n,
        ...
        o =
          null !==
            ...
            ? i
            : (0, e.V)()
      return (0, r.Z)(o + '/v1/projects/' + t + '/settings')
        .then(function (t) {
          return t.json()
        })
        .catch(function (t) {
    ...
    function pt(t) {
      return (
        'test' !==
          ('undefined' != typeof process && process.env ? process.env : {})
            .NODE_ENV && Object.keys(t.integrations).length > 1
      )
    }
    function dt(e) {
      return (0, t.mG)(this, void 0, Promise, function () {
        ...
        return (0, t.Jh)(this, function (l) {
          switch (l.label) {
              ...
              ;(n = window.analytics),
                ...
                (i = function (n, r) {
                  ...
                  return (0, t.Jh)(this, function (o) {
                    switch (o.label) {
                      case 0:
                        return e[n] && 'function' == typeof e[n]
                          ? 'addSourceMiddleware' !== n
                            ? [3, 2]
                            : [4, (i = e[n]).call.apply(i, (0, t.pr)([e], r))]
                          : [3, 3]
                      case 1:
                        return o.sent(), [3, 3]
                      case 2:
            ...
            case 1:
              return o < u.length
                ? ((s = u[o]), (a = s[0]), (c = s.slice(1)), [5, i(a, c)])
                : [3, 4]
            case 2:
              l.sent(), (l.label = 3)
            case 3:
    ...
    function ht(e, n, r, i, o) {
      ...
      return (0, t.mG)(this, void 0, Promise, function () {
        var l,
          ...
          g,
          b = this
        return (0, t.Jh)(this, function (w) {
          switch (w.label) {
            case 0:
              return pt(e)
                ? [
                    4,
                    Promise.all([u.e(130), u.e(464)])
                      .then(u.bind(u, 3234))
                      .then(function (t) {
                        return t.ajsDestinations(e, n.integrations, r)
                      }),
                  ]
                : [3, 2]
            case 1:
            ...
            case 4:
              w.sent(), (w.label = 5)
            case 5:
              return (null === (s = r.plan) || void 0 === s ? void 0 : s.track)
                ? [
                    4,
                    u
                      .e(493)
            ...
            case 9:
              return (
                ...
                d && m.push(d),
                (!1 ===
                  (null === (a = r.integrations) || void 0 === a
                    ? void 0
                    : a.All) &&
                  !r.integrations['Segment.io']) ||
                  (r.integrations && !1 === r.integrations['Segment.io']) ||
                  m.push(lt(n, v['Segment.io'], e.integrations)),
                [4, n.register.apply(n, m)]
              )
            case 10:
              return (
                (g = w.sent()),
                Object.keys(
                  null !== (c = e.enabledMiddleware) && void 0 !== c ? c : {}
                ).length > 0
                  ? [
                      4,
                      u
                        ...
                        .then(function (r) {
                          ...
                          return (0, t.mG)(b, void 0, void 0, function () {
                            var r, o
                            return (0, t.Jh)(this, function (t) {
                              switch (t.label) {
                                case 0:
        ...
        return (
          (e.load = function (e, n) {
            ...
            return (
              void 0 === n && (n = {}),
              (0, t.mG)(this, void 0, Promise, function () {
                var a, c, l, f, p, d, h, v, y
                return (0, t.Jh)(this, function (m) {
                  switch (m.label) {
                    case 0:
                      return [4, ft(e.writeKey)]
                    case 1:
                      return (
                        (a = m.sent()),
                        (c =
                          null ===
                            (i =
                              null === (r = a.integrations['Segment.io']) ||
                              void 0 === r
                                ? void 0
                                : r.retryQueue) ||
                          void 0 === i ||
                          i),
                        (l = (0, t.pi)({ retryQueue: c }, n)),
                        (f = new R(e, l)),
                        (p = null !== (o = e.plugins) && void 0 !== o ? o : []),
                        b._.initMetrics(a.metrics),
                        (function (e) {
                    ...
                    case 2:
                      return (
                        ...
                        n.initialPageview && f.page().catch(console.error),
                        (h =
                          null !== (u = window.location.search) && void 0 !== u
                            ? u
                            : ''),
                        (v =
                          null !== (s = window.location.hash) && void 0 !== s
                            ? s
                            : ''),
                        (y = h.length
                          ? h
                          : v.replace(/(?=#).*(?=\?)/, '')).includes('ajs_') &&
                          f.queryString(y).catch(console.error),
                        [4, dt(f)]
                      )
                    case 3:
                      return m.sent(), [2, [f, d]]
      ...
      var t,
        ...
        n = (function () {
          ...
          for (
            ...
            var o =
              null !== (t = i[r].getAttribute('src')) && void 0 !== t ? t : ''
            if ((u = e.exec(o)) && u[1]) {
              n = u[1]
              break
            }
    ...
    var xt =
      null !==
        (bt =
          null === (gt = window.analytics) || void 0 === gt
            ? void 0
            : gt._cdn) && void 0 !== bt
        ? bt
        : (0, e.V)()
          ...
          switch (t.label) {
            ...
            case 2:
              return (
                ...
                new wt.B().increment('analytics_js.invoke.error', [
                  'type:initialization',
    ...
    if (
      (window.analytics && (window.analytics._cdn = xt),
      (u.p = xt
        ? xt + '/analytics-next/bundles/'
        ...
        ;(function (n) {
          return (0, t.mG)(this, void 0, Promise, function () {
            ...
            return (0, t.Jh)(this, function (t) {
              switch (t.label) {
                case 0:
                  return 'report' === n.disposition ||
                    !n.blockedURI.includes('cdn.segment') ||
                    _t
                    ? [2]
                    : ((_t = !0),
                      console.warn(
      ...
      It.setAttribute(
        ...
        'loading' === document.readyState
          ? document.addEventListener('DOMContentLoaded', function () {
              return document.body.appendChild(It)
            })
